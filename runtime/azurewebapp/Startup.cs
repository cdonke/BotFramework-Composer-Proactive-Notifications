...
using Microsoft.BotFramework.Composer.WebApp.ProactiveNotifications;
...
namespace Microsoft.BotFramework.Composer.WebAppTemplates
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            // Add Collection to keep conversations.
            ...
            services.AddSingleton<IActivityStorage>((sp)
                => new ActivityStorage(settings));
